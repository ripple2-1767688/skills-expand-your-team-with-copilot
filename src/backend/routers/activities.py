...
def get_activities(
    ...
    - difficulty: Filter by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'none' for activities without difficulty)
    """
    ...
    if difficulty:
        if difficulty.lower() == "none":
            # "All" (or "none") means only activities without a difficulty field
